  ...
  <div class="widget recent-posts">
    ...
    <div v-if="recentPostsLoaded">
      <div v-for="post in recentPosts(limit)" :key="post.id">
        <a :href="getUrlPost(post.slug)">{{ post.title.rendered }}</a>
...
export default {
  ...
  mounted() {
    console.log("limit:"+this.limit+" lang:"+this.$i18n.locale);
    this.$store.dispatch('getPosts', { limit: this.limit, lang: this.$i18n.locale});
  },
};
</script>
